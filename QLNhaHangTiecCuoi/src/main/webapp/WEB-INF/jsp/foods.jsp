...
<h1 class="text-center text-info">MÓN ĂN</h1>
    ...
    <div class="row">
        <c:forEach items="${food}" var="f">
            <div class="col-md-3 col-xs-12" style="padding: 5px;">
                <div class="card">
                    <img class="card-img-top" class="img-thumbnail card-img-top img-fluid" src="${f.image}" alt="Card image" style="width: auto; height: 200px">
                    <div class="card-body">
...
<ul class="pagination justify-content-end">
    <c:forEach begin="1" end="${Math.ceil(foodCounter/8)}" var="i">
