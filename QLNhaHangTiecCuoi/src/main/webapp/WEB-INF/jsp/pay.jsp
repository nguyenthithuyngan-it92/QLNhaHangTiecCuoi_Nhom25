...
<!-- Tab links -->
<div class="tab">
    <button class="tablinks active" onclick="openCity(event, 'pay')">HÓA ĐƠN CHƯA THANH TOÁN</button>
    <button class="tablinks" onclick="openCity(event, 'paid')">HÓA ĐƠN ĐÃ THANH TOÁN</button>
</div>

<!-- Tab content -->
<div id="pay" class="tabcontent" style="display:block;">
